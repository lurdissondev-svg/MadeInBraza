...
val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "braza_prefs")
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideBrazaApi(retrofit: Retrofit): BrazaApi {
        return retrofit.create(BrazaApi::class.java)
    }
