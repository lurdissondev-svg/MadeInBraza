      ...
      <div class="bg-dark-800 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="p-6 space-y-6">
          ...
          <a
            v-else-if="apkUrl"
            :href="apkUrl"
            class="flex items-center justify-center gap-2 w-full py-3 px-4 bg-primary-500 hover:bg-primary-400 text-dark-900 font-semibold rounded-xl transition-colors"
          >
