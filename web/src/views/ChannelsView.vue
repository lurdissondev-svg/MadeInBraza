...
<template>
  <MainLayout>
    <div class="space-y-4">
      ...
      <!-- Loading -->
      <div v-if="channelsStore.loading && (!channelsStore.channels || channelsStore.channels.length === 0)" class="flex justify-center py-12">
        <LoadingSpinner />
      </div>
      ...
      <!-- Empty -->
      <template v-else-if="!channelsStore.channels || channelsStore.channels.length === 0">
